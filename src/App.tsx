...
const CourseEditorPage = lazy(() => import("@/modules/admin/pages/CourseEditorPage"));
...
const AdminEventsPage = lazy(() => import("@/modules/admin/pages/AdminEventsPage"));
...
const VipAreaPage = lazy(() => import("@/modules/library/pages/VipAreaPage"));
...
const EventsListingPage = lazy(() => import("@/modules/events/pages/EventsListingPage"));
...
const StudentEventsPage = lazy(() => import("@/modules/events/pages/StudentEventsPage"));
...
const InstructorCourseEditorPage = lazy(() => import("@/modules/instructor/pages/InstructorCourseEditorPage"));
      ...
      <TooltipProvider>
        ...
        <BrowserRouter basename={routerBasename}>
          ...
          <Routes>
            ...
            {/* Content / Community / Events / VIP */}
            <Route path={ROUTES.vipArea} element={<VipAreaPage />} />
            ...
            <Route path={ROUTES.eventsPublic} element={<EventsListingPage />} />
            <Route path="/eventos/:eventSlug" element={<EventDetailPage />} />
            ...
            <Route path={ROUTES.events} element={studentRoute(<StudentEventsPage />)} />
            ...
            <Route path={ROUTES.instructorCourseNew} element={instructorRoute(<InstructorCourseEditorPage />)} />
            <Route path="/instrutor/cursos/:id" element={instructorRoute(<InstructorCourseEditorPage />)} />
            ...
            <Route path={ROUTES.adminCourseNew} element={adminRoute(<CourseEditorPage />)} />
            <Route path="/admin/cursos/:id" element={adminRoute(<CourseEditorPage />)} />
            ...
            <Route path={ROUTES.adminEvents} element={adminRoute(<AdminEventsPage />)} />

...
const ProducerDashboardPage = () => {
  ...
  const stats = [
    { label: 'Saldo líquido', value: formatPrice(data.financial.availableBalanceCents, data.financial.currency), icon: WalletCards },
  ...
  return (
    <ProducerLayout>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <section>
          <div className="mb-3"><p className="vdm-eyebrow">Operação</p><h2 className="mt-1 text-xl font-semibold">Pedidos recentes</h2></div>
          <DataTable
            rows={data.recentOrders}
            rowKey={(item) => item.id}
            emptyLabel="Nenhum pedido recebido."
            columns={[

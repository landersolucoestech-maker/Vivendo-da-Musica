...
type DashboardData = ReturnType<typeof useStudentDashboard>;
...
interface StudentDashboardHeroProps {
  firstIncompleteLesson: DashboardData['firstIncompleteLesson'];
  firstName: string;
...
interface ContinueLearningSectionProps {
  activeModule: DashboardData['activeModule'];
  firstIncompleteLesson: DashboardData['firstIncompleteLesson'];
}
...
interface StudentDashboardSidebarProps {
  joinDate: string;
  modulesCount: number;
  recentCertificates: DashboardData['recentCertificates'];
  recommendedDownloads: DashboardData['recommendedDownloads'];
  totalLessons: number;
}
    ...
    <section className="rounded-2xl border border-white/8 bg-[#101010] p-5">
      ...
      <div className="mt-5 divide-y divide-white/8">
        <div className="flex items-center justify-between py-3 first:pt-0">
          ...
          <span className="text-sm font-semibold text-white">{modulesCount}</span>
        </div>

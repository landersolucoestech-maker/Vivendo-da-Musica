        ...
        <section className="hidden border-r border-white/10 bg-black/25 px-12 py-10 lg:flex lg:flex-col lg:justify-between xl:px-20">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="mt-3 font-display text-5xl font-bold leading-[1.08] tracking-[-0.05em] text-white">
              Aprenda, pratique e construa uma carreira na música.
            </h1>
            <p className="mt-6 max-w-lg text-base leading-8 text-muted-foreground">
              Acesse cursos, materiais, produtos digitais e ferramentas pensadas para sua evolução profissional.
            </p>
          </div>
            ...
            <Card className="border-white/12 bg-card/95 shadow-[0_28px_80px_rgba(0,0,0,0.42)] backdrop-blur-xl">
              <CardHeader className="space-y-2 pb-5">
                ...
                <CardDescription className="text-sm leading-6">
                  Informe suas credenciais para acessar seu portal.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex justify-end">
                    <Link to={ROUTES.forgotPassword} className="link-vdm text-sm">
                      Esqueceu a senha?
                    </Link>
                  </div>
                ...
                <div className="border-t border-white/8 pt-5 text-center text-sm text-muted-foreground">
                  ...
                  <Link to={ROUTES.register} className="link-vdm font-semibold">
                    Matricule-se
                  </Link>
                </div>
              </CardContent>

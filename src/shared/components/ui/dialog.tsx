...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-display text-xl font-semibold leading-tight tracking-[-0.025em] text-white sm:text-2xl', className)}
    {...props}
  />
));

...
-- "manual" is accepted by both the historical enrollment_source enum and the
-- current text/check-constraint contract used by the Supabase development branch.

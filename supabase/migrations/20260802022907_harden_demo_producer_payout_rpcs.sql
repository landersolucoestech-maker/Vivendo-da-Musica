...
revoke all on function app_private.transition_demo_producer_payout(uuid, text) from public, anon, authenticated;
grant execute on function app_private.transition_demo_producer_payout(uuid, text) to service_role;
